...
$email = 'admin@worldoftravel.co.in';
...
try {
	...
	$mail->Username = 'admin@worldoftravel.co.in';                    // SMTP username
	$mail->Password = 'alpha&trion';                              // SMTP password
	$mail->SMTPSecure = 'ssl';                               // Enable encryption, 'ssl' also accepted
	$mail->Port = 465;   								       // TCP port to connect to

	$mail->AddAddress($email);	 						       // Add another recipient

	//$mail->AddAddress('harshoswal711@gmail.com', 'Person 2');     // Add a secondary recipient
